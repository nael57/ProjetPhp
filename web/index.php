	...
	<div id="fh5co-counter" class="fh5co-counters">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3 text-center animate-box"><!-- Mettre dans le data-to le nombre courant d'article dans lpanier -->
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					<h2><strong>Créer un coffret personnalisé n'a jamais été aussi simple !</strong></h2>
				</div>
			</div>
				...
				<div class="row">
					...
					<div class="col-md-4 col-md-pull-8 animate-box">
						<div class="mt">
							...
							<p>Aves des années de travail, GiftBox a su s'entourer des meilleurs partenaires nationaux afin de proposer des prestations de qualité à des prix défiants toute concurrence.</p>
							<ul class="list-nav">
					...
					<div class="col-md-4 animate-box">
						<div class="mt">
							...
							<div>
								...
								<p>Une équipe de 5 programmateurs/commerciaux dévoués vous assure la stabilité du service ainsi qu'un large panel de prestations de qualité.</p>
							</div>
							<div>
								<h4><i class="icon-shield"></i>Un développement inégalé</h4>
								<p>GiftBox se développe de plus en plus à l'échelle nationale, de ce fait, nous obtenons les meilleurs clients ainsi que les meilleurs tarifs.</p>
							</div>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="images/animateur.jpg" class="img-responsive">
						<h3>Un cours d'Aqua-Gym</h3>
						<span>Plus d'infos</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="images/bijoux.jpg" class="img-responsive">
						<h3>Un lot de bijoux</h3>
						<span>Plus d'infos</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="images/boitedenuit.jpg" class="img-responsive">
						<h3>Un showcase d'un artiste au choix</h3>
						<span>Plus d'infos</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="images/bonroi.jpg" class="img-responsive">
						<h3>Un dîner au "Bon Roi"</h3>
						<span>Plus d'infos</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="images/concert.jpg" class="img-responsive">
						<h3>Une place de concert</h3>
						<span>Plus d'infos</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="images/gouter.jpg" class="img-responsive">
						<h3>Un goûter haut de gamme</h3>
						<span>Plus d'infos</span>
					</a>
				</div>
			</div>
						...
						<div class="owl-carousel owl-carousel-fullwidth">
							<div class="item">
								<div class="testimony-slide active text-center">
									...
									<blockquote>
										<p>&ldquo;Je m'occupe de toute la partie design ainsi que la recherche de prestations et l'amélioration du code interne permettant ainsi au site d'être le plus optimisé possible pour nos clients&rdquo;</p>
									</blockquote>
								</div>
							</div>
							<div class="item">
